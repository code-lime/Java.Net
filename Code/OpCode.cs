...
{
    public interface OpCode : IEquatable<OpCode>
    {
        string Name { get; }
    ...
    public readonly struct OpCode<I> : OpCode where I : IInstruction<I>
    {
        /*
[+] byte: bipush
[+] const: iinc
...
[+] ???wide???
        */
        ...
        public static bool operator ==(OpCode<I> a, OpCode b) => a is OpCode op && op.Equals(b);
